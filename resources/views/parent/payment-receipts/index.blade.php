                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900">{{ $pendingPaymentsCount }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="overflow-hidden rounded-lg bg-white shadow-sm">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <p class="text-sm font-medium text-gray-500">Justificantes Médicos</p>
                                <p class="text-2xl font-semibold text-gray-900">{{ $medicalJustificationsCount }}</p>
                            </div>
                        </div>
                    </div>
                </div>
