            ...
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="border-b border-gray-200 bg-white px-4 py-5 sm:px-6">
                    ...
                    <p class="mt-1 max-w-2xl text-sm text-gray-500">
                        Actualiza el nivel de competencia del docente en la materia.
                    </p>
                </div>

                <form action="{{ route('admin.teacher-subjects.update', $teacherSubject) }}" method="POST" class="p-6">
                    @csrf
                    @method('PUT')
                        ...
                        <div>
                            ...
                            <div class="mt-2 space-y-3">
                                <input type="range" name="proficiency" id="proficiency" min="1" max="10"
                                    value="{{ old('proficiency', $teacherSubject->proficiency) }}"
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="text-center">
                                        <span id="proficiencyLabel" class="text-lg font-bold text-blue-600">{{ old('proficiency', $teacherSubject->proficiency) }}/10</span>
                                    </div>
                                    <div>
