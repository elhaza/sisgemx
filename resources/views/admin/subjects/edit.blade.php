                ...
                <div class="p-6">
                    <form action="{{ route('admin.subjects.update', $subject) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="default_hours_per_week" id="default_hours_per_week" step="0.5" min="0.5" max="40" value="{{ old('default_hours_per_week', $subject->default_hours_per_week) }}"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
