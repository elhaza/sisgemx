<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('admin.time-slots.create') }}"
            ...
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                ...
                @else
                    <div class="px-6 py-12 text-center">
                        ...
                        <h3 class="mt-2 text-sm font-medium text-gray-900">No hay franjas horarias</h3>
                        <p class="mt-1 text-sm text-gray-500">
                            Comienza creando una nueva franja horaria.
                        </p>
                        <div class="mt-6">
                            <a href="{{ route('admin.time-slots.create') }}"
