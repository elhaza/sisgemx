                    ...
                    <form action="{{ route('finance.payment-receipts.index') }}" method="GET">
                        ...
                        <div class="flex flex-wrap items-center gap-2">
                            ...
                            <div class="flex gap-2 ml-auto">
                                <a href="{{ route('finance.payment-receipts.export-excel', request()->query()) }}" class="rounded-md bg-green-600 px-3 py-1.5 text-sm font-medium text-white hover:bg-green-700 flex items-center gap-1">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                                    </svg>
                                    Excel
                                </a>
                                <a href="{{ route('finance.payment-receipts.export-pdf', request()->query()) }}" class="rounded-md bg-red-600 px-3 py-1.5 text-sm font-medium text-white hover:bg-red-700 flex items-center gap-1">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
