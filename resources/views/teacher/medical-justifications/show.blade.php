        ...
        <div class="mx-auto max-w-4xl sm:px-6 lg:px-8">
                    ...
                    <dl class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        <div>
                            ...
                            <dd class="mt-1 text-sm text-gray-900">
                                ...
                                <div class="text-gray-600">{{ $medicalJustification->student->grade_level }}</div>
                            </dd>
                        </div>
                ...
                <div class="p-6">
                    <dl class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        <div>
                            ...
                            <dd class="mt-1 text-sm text-gray-900">{{ $medicalJustification->student->grade_level }}</dd>
                        </div>
            ...
            @if($medicalJustification->status === 'pending')
                <div class="mt-6 flex gap-4">
                    <form action="{{ route('teacher.medical-justifications.approve', $medicalJustification) }}" method="POST" class="flex-1">
                        @csrf
                        @method('PATCH')
                ...
                <x-modal name="reject-justification" focusable>
                    <form method="POST" action="{{ route('teacher.medical-justifications.reject', $medicalJustification) }}" class="p-6">
                        @csrf
                        @method('PATCH')
