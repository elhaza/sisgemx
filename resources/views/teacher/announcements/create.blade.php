        ...
        <div class="mx-auto max-w-2xl sm:px-6 lg:px-8">
            <div class="overflow-hidden rounded-lg bg-white shadow-sm">
                <div class="border-b border-gray-200 bg-gray-50 px-6 py-4">
                    <h3 class="text-lg font-semibold text-gray-900">Formulario de Anuncio</h3>
                </div>
                                ...
                                <div class="mt-2 space-y-2">
                                    <label class="flex items-center">
                                        <input
                                            ...
                                            value="students"
                                            @if(in_array('students', old('target_audience', []))) checked @endif
                                    ...
                                    <label class="flex items-center">
                                        <input
                                            ...
                                            name="target_audience[]"
                                            value="parents"
                                            @if(in_array('parents', old('target_audience', []))) checked @endif
                                            class="rounded border-gray-300"
                                        />
                                    ...
                                    <label class="flex items-center">
                                        <input
                                            ...
                                            name="target_audience[]"
                                            value="teachers"
                                            @if(in_array('teachers', old('target_audience', []))) checked @endif
                                            class="rounded border-gray-300"
                                        />
